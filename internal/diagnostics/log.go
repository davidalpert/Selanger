...
import (
	...
	"github.com/davidalpert/selanger/internal/diagnostics/plaintext"
	"github.com/davidalpert/selanger/internal/env"
	"github.com/davidalpert/selanger/internal/version"
	"io"
	"os"
	"path/filepath"
	"strings"
...
const (
	ENVKEY_LOG_LEVEL  = "SELANGE_LOG_LEVEL"
	ENVKEY_LOG_FORMAT = "SELANGE_LOG_FORMAT"
	ENVKEY_LOG_FILE   = "SELANGE_LOG_FILE"
)
